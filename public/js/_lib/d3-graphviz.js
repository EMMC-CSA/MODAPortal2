(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-selection'), require('d3-dispatch'), require('d3-transition'), require('d3-timer'), require('d3-zoom'), require('d3-interpolate'), require('viz.js'), require('d3-format')) :
  typeof define === 'function' && define.amd ? define(['exports', 'd3-selection', 'd3-dispatch', 'd3-transition', 'd3-timer', 'd3-zoom', 'd3-interpolate', 'viz.js', 'd3-format'], factory) :
  (factory((global.d3 = global.d3 || {}),global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global.Viz,global.d3));
}(this, function (exports,d3,d3Dispatch,d3Transition,d3Timer,d3Zoom,d3Interpolate,Viz,d3Format) { 'use strict';
